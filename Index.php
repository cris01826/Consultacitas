...
">
  ...
  <body>
    <form class="login" action="" method="post">
    	...
    	<a href=""><small>Registro</small></a><br>
    	<a href=""><small>Recuperar Contraseña</small></a><br><br>
    	<button type="submit" name="submit" class="btn btn-outline-primary">Ingresar</button>
    </form>
